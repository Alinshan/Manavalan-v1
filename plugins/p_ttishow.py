...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 Updates', url='https://t.me/movies_hub_tg1')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        ...
        for u in message.new_chat_members:
            if (temp.MELCOW).get('welcome') is not None:
                try:
                    ...
                    pass
            temp.MELCOW['welcome'] = await message.reply(f"<b>𝐇𝐄𝐘 , {u.mention}, 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 {message.chat.title} 𝐇𝐀𝐏𝐏𝐘 𝐓𝐎 𝐇𝐀𝐕𝐄 𝐇𝐄𝐑𝐄</b>")
